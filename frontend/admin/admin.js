...
function openPackageForm(pkg) {
  ...
  const form = el("form", {}, [
    ...
    formGroup("Image filename (in /images, leave blank for icon)", imageInput),
...
function openDestinationForm(dest) {
  ...
  const imageInput = textInput(dest?.image || "");
